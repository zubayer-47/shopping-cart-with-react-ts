...
export default function Nav() {
  const { quantity, cartOpen } = useSelector(storeSelector);
    ...
    <>
      <div className="max-w-4xl mx-auto flex justify-between">
        ...
        {quantity ? (
          <button
            onClick={handleClick}
            className="relative mt-1 w-12 h-12 flex justify-center items-center border-2 border-indigo-400 rounded-full"
          >
            <svg
